...
export function sidebar(){
  ...
  <div class="sidebar-footer">
    <p class="copyright"><a href="https://twitter.com/xanaqwert">Made by sahl, gopur, alim</a>
    </p>
    <div class="social-link">
    <a href="https://twitter.com/xanaqwert" alt="Social handles" target="_blank">Twitter</a>
    <a href="https://github.com/xanaqwert/xanaqwert" alt="Social handles" target="_blank">Github</a>
    <a href="https://www.instagram.com/xanaqwerty/" alt="Social handles" target="_blank">Instagram</a>
    </div>
  </div>
`;
